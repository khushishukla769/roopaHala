    ...
    return (
      ...
      >
        <button
          ...
          type="submit"
          onClick={onSubmit}
          className="w-[163px] h-16 bg-orange rounded-xl text-common text-[24px]
          leading-[100%] tracking-[0] text-center align-middle transition-colors flex
        ...
        {showForgotPassword && (
          <button
            ...
            text-common text-[20px] leading-[150%] tracking-[0] border border-lightGray
        ...
        <div className="flex items-center gap-[10px]">
          ...
          />
          <span className="text-common text-[20px] leading-[150%] tracking-[0] text-center capitalize">
            Remember Email
          </span>
        </div>
      </div>
